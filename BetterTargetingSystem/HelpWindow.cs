...
public class HelpWindow : Window, IDisposable
{
    ...
    public override void Draw()
    {
        ...
        ImGui.Text("It also adds an extra keybind to target the lowest (absolute) health enemy as well as a keybind to target the \"best\" enemy for targeted aoes. Those keybinds are disabled in PvP.");
